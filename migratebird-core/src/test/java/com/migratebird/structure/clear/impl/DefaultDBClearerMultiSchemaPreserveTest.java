...
import static com.migratebird.util.SQLTestUtils.executeUpdate;
import static com.migratebird.util.SQLTestUtils.executeUpdateQuietly;
import static com.migratebird.util.TestUtils.getDatabases;
import static com.migratebird.util.TestUtils.getDefaultExecutedScriptInfoSource;
import static org.junit.Assert.assertEquals;

/**
 * Test class for the {@link com.migratebird.structure.clear.DBClearer} using multiple database schemas with configuration to preserve all items. <p/>
