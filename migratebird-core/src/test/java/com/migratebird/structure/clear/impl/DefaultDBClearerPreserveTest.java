...
public class DefaultDBClearerPreserveTest {
    ...
    private void createTestDatabaseHsqlDb() {
        ...
        // create triggers
        executeUpdate("create trigger test_trigger before insert on \"Test_CASE_Table\" call \"com.migratebird.structure.clear.impl.DefaultDBClearerPreserveTest.TestTrigger\"", dataSource);
        executeUpdate("create trigger \"Test_CASE_Trigger\" before insert on \"Test_CASE_Table\" call \"com.migratebird.structure.clear.impl.DefaultDBClearerPreserveTest.TestTrigger\"", dataSource);
    }
