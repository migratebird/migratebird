...
public class SQLTestUtils {
    ...
    public static int executeUpdate(String sql, DataSource dataSource) {
        ...
        try {
            ...
            throw new MigrateBirdException("Error while executing statement: " + sql, e);
        } finally {
    ...
    /**
     * Returns the long extracted from the result of the given query. If no value is found, a {@link MigrateBirdException}
     * is thrown.
     *
     * @param sql        The sql string for retrieving the items
     * @param dataSource The data source, not null
    ...
    public static long getItemAsLong(String sql, DataSource dataSource) {
        ...
        throw new MigrateBirdException("No item value found: " + sql);
    }


    /**
     * Returns the value extracted from the result of the given query. If no value is found, a {@link MigrateBirdException}
     * is thrown.
     *
     * @param sql        The sql string for retrieving the items
     * @param dataSource The data source, not null
