...
public class ScriptFactoryTargetDatabaseNameTest {
    ...
    public void initialize() {
        Properties configuration = new ConfigrationLoader().loadDefaultConfiguration();
        ...
        scriptFactory = new ScriptFactory(scriptIndexRegexp, targetDatabaseRegexp, qualifierRegexp, null, null, null, null);
    }
