...
public class FileSystemScriptLocation extends ScriptLocation {
    ...
    protected void assertValidScriptLocation(File scriptLocation) {
        if (scriptLocation == null || !scriptLocation.exists()) {
            throw new MigrateBirdException("Script location " + scriptLocation + " does not exist.");
        }
    }
     ...
     * @throws MigrateBirdException if the properties file is invalid
     */
    @Override
    protected Properties getCustomProperties(File scriptLocation) {
        ...
        try {
            ...
            throw new MigrateBirdException("Error while reading configuration file " + customPropertiesFileLocation, e);
        } finally {
