        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                try {
                    ...
                    throw new MigrateBirdException("Error when parsing date " + executedAt + " using format " + timestampFormat, e);
                }
            ...
            throw new MigrateBirdException("Error while retrieving database version", e);
        } finally {
