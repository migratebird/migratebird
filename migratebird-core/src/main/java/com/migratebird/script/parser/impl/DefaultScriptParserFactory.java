 ...
 */
package com.migratebird.script.parser.impl;
...
import com.migratebird.script.parser.parsingstate.impl.EscapingParsingState;
import com.migratebird.script.parser.parsingstate.impl.InBlockCommentParsingState;
import com.migratebird.script.parser.parsingstate.impl.InCurlyBraceBlockCommentParsingState;
import com.migratebird.script.parser.parsingstate.impl.InDoubleQuotesParsingState;
import com.migratebird.script.parser.parsingstate.impl.InLineCommentParsingState;
import com.migratebird.script.parser.parsingstate.impl.InSingleQuotesParsingState;
import com.migratebird.script.parser.parsingstate.impl.NeverMatchingPlSqlBlockMatcher;
import com.migratebird.script.parser.parsingstate.impl.PlSqlBlockNormalParsingState;
import com.migratebird.script.parser.parsingstate.impl.SqlStatementNormalParsingState;
...
public class DefaultScriptParserFactory implements ScriptParserFactory {
    ...
    /**
     * Factory method that returns the correct implementation of {@link com.migratebird.script.parser.parsingstate.PlSqlBlockMatcher}
     *
