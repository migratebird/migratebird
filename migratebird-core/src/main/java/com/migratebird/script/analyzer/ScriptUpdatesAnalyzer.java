 ...
 */
package com.migratebird.script.analyzer;

import static com.migratebird.script.analyzer.ScriptUpdateType.HIGHER_INDEX_SCRIPT_ADDED;
import static com.migratebird.script.analyzer.ScriptUpdateType.INDEXED_SCRIPT_DELETED;
import static com.migratebird.script.analyzer.ScriptUpdateType.INDEXED_SCRIPT_UPDATED;
import static com.migratebird.script.analyzer.ScriptUpdateType.LOWER_INDEX_NON_PATCH_SCRIPT_ADDED;
import static com.migratebird.script.analyzer.ScriptUpdateType.LOWER_INDEX_PATCH_SCRIPT_ADDED;
import static com.migratebird.script.analyzer.ScriptUpdateType.POSTPROCESSING_SCRIPT_ADDED;
import static com.migratebird.script.analyzer.ScriptUpdateType.POSTPROCESSING_SCRIPT_DELETED;
import static com.migratebird.script.analyzer.ScriptUpdateType.POSTPROCESSING_SCRIPT_FAILURE_RERUN;
import static com.migratebird.script.analyzer.ScriptUpdateType.POSTPROCESSING_SCRIPT_RENAMED;
import static com.migratebird.script.analyzer.ScriptUpdateType.POSTPROCESSING_SCRIPT_UPDATED;
import static com.migratebird.script.analyzer.ScriptUpdateType.REPEATABLE_SCRIPT_ADDED;
import static com.migratebird.script.analyzer.ScriptUpdateType.REPEATABLE_SCRIPT_DELETED;
import static com.migratebird.script.analyzer.ScriptUpdateType.REPEATABLE_SCRIPT_RENAMED;
import static com.migratebird.script.analyzer.ScriptUpdateType.REPEATABLE_SCRIPT_UPDATED;
...
public class ScriptUpdatesAnalyzer {
     ...
     * scripts from the given {@link com.migratebird.script.repository.ScriptRepository}. It also needs to know whether a new patch script with a lower
     ...
     * whether it is a regular or irregular one.
     *
     * @return {@link com.migratebird.script.analyzer.ScriptUpdates} object that represents all updates that were performed to the scripts since the last
     *         database update
     */
