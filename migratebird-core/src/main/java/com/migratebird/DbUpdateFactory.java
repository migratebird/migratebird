...
public class DbUpdateFactory extends FactoryWithDatabase<DbUpdate> {

    @Override
    public DbUpdate createInstance() {
        ...
        return new DefaultDbUpdate(scriptRunner, scriptRepository, executedScriptInfoSource, fromScratchEnabled,
