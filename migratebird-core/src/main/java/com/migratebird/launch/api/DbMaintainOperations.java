...
public class DbMaintainOperations {
    ...
    private static final String DBMAINTAIN_PROPERTIES = "migratebird.properties";
    ...
    public static void updateDatabase() {
        DbMaintainer migratebird = getMainFactory().createDbMaintainer();
     ...
     * DbMaintain, or after having manually fixed a problem.
     */
    ...
    private static MainFactory getMainFactory() {
        ...
        if (propertiesFromClassPath == null) {
            throw new MigrateBirdException("Could not find properties file " + DBMAINTAIN_PROPERTIES + " in classpath");
        }
