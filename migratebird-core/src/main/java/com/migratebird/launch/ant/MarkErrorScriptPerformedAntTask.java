...
import com.migratebird.launch.task.MarkErrorScriptPerformedTask;
 ...
 *
*/
public class MarkErrorScriptPerformedAntTask extends BaseDatabaseAntTask {


    @Override
    protected MigrateBirdTask createMigrateBirdTask() {
        return new MarkErrorScriptPerformedTask(getMigrateBirdDatabases());
    }
